...
final class Loc: ObservableObject {
    ...
    static let english: [String: String] = [
        ...
        "tut.2.title": "The Secure Enclave helper is built",
        "tut.2.body": "A tiny Swift program that holds the hardware key. Without it, only plain mode works. It builds itself the first time you store an enclave secret.",
        "tut.2.action": "Open Diagnostics",
        "tut.3.title": "Store a plain secret",
        "tut.3.body": "Plain lives in the macOS Keychain, readable by Hermes at any time. Use it for keys your daemons and cron jobs need at boot.",
        "tut.3.action": "Add a secret",
        "tut.4.title": "Store an enclave secret",
        "tut.4.body": "Enclave is wrapped by a key that never leaves the chip and needs Touch ID to open. Use it for the keys you would rather see fail than leak.",
        "tut.4.action": "Add an enclave secret",
        "tut.5.title": "Open a session with Touch ID",
        "tut.5.body": "One fingerprint unwraps every enclave secret for a few hours. Hermes reads them from that session, not from the chip.",
        "tut.5.action": "Unlock",
        "tut.6.title": "Lock when the screen locks",
        "tut.6.body": "When you walk away the session closes with the screen. Costs one Touch ID when you come back; closes the window between lock and expiry.",
        "tut.6.action": "Turn on",
        ...
        "profiles.separate": "The two crypto engines stay separate on purpose. Only this dashboard is shared, so neither system has to pretend to be the other.",
        "profiles.allProfiles": "Profiles",
        "profiles.active": "ACTIVE",
        "profiles.yubikeyBacked": "Sealed to a YubiKey — unsealing needs the key and its PIN",
        "profiles.stateSealed": "Sealed",
        "profiles.stateOpen": "Open",
        "profiles.stateUnmanaged": "Not managed",
        "profiles.seal": "Seal",
        "profiles.unseal": "Unseal",
        "profiles.lock": "Lock",
        "profiles.verify": "Verify",
        "profiles.sealTitle": "Seal profile",
        "profiles.unsealTitle": "Unseal profile",
        "profiles.sealExplain": "The .env is encrypted and the plaintext shredded. The profile cannot call any model until it is unsealed.",
        "profiles.unsealExplain": "Your passphrase decrypts the .env for this session.",
        "profiles.pinExplain": "This profile is sealed to a YubiKey. Enter the key's PIN, then touch the key when it blinks.",
        "profiles.passField": "Passphrase",
        "profiles.passConfirm": "Confirm passphrase",
        "profiles.pinField": "YubiKey PIN",
    ...
    static let french: [String: String] = [
        ...
        "tut.2.title": "Le helper Secure Enclave est compilé",
        "tut.2.body": "Un petit programme Swift qui tient la clé matérielle. Sans lui, seul le mode plain fonctionne. Il se compile tout seul au premier secret enclave.",
        "tut.2.action": "Ouvrir Diagnostic",
        "tut.3.title": "Stocker un secret plain",
        "tut.3.body": "Plain vit dans le Trousseau macOS, lisible par Hermes à tout moment. Pour les clés dont vos démons et crons ont besoin au démarrage.",
        "tut.3.action": "Ajouter un secret",
        "tut.4.title": "Stocker un secret enclave",
        "tut.4.body": "Enclave est enveloppé par une clé qui ne quitte jamais la puce et demande Touch ID pour s'ouvrir. Pour les clés que vous préférez voir échouer plutôt que fuir.",
        "tut.4.action": "Ajouter un secret enclave",
        "tut.5.title": "Ouvrir une session avec Touch ID",
        "tut.5.body": "Une empreinte déballe tous les secrets enclave pour quelques heures. Hermes les lit depuis cette session, pas depuis la puce.",
        "tut.5.action": "Déverrouiller",
        "tut.6.title": "Verrouiller avec l'écran",
        "tut.6.body": "Quand vous partez, la session se ferme avec l'écran. Un Touch ID au retour ; ferme la fenêtre entre verrouillage et expiration.",
        "tut.6.action": "Activer",
        ...
        "profiles.separate": "Les deux moteurs de chiffrement restent séparés volontairement. Seul ce tableau de bord est partagé, donc aucun système n'a besoin de faire semblant d'être l'autre.",
        "profiles.allProfiles": "Profils",
        "profiles.active": "ACTIF",
        "profiles.yubikeyBacked": "Scellé sur une YubiKey — le descellement exige la clé et son PIN",
        "profiles.stateSealed": "Scellé",
        "profiles.stateOpen": "Ouvert",
        "profiles.stateUnmanaged": "Non géré",
        "profiles.seal": "Sceller",
        "profiles.unseal": "Desceller",
        "profiles.lock": "Verrouiller",
        "profiles.verify": "Vérifier",
        "profiles.sealTitle": "Sceller le profil",
        "profiles.unsealTitle": "Desceller le profil",
        "profiles.sealExplain": "Le .env est chiffré et le texte clair détruit. Le profil ne peut plus appeler aucun modèle tant qu'il n'est pas descellé.",
        "profiles.unsealExplain": "Votre phrase secrète déchiffre le .env pour cette session.",
        "profiles.pinExplain": "Ce profil est scellé sur une YubiKey. Saisissez le PIN de la clé, puis touchez-la quand elle clignote.",
        "profiles.passField": "Phrase secrète",
        "profiles.passConfirm": "Confirmer la phrase secrète",
        "profiles.pinField": "PIN de la YubiKey",
        ...
        "msg.done": "terminé",
        "msg.sealing": "Scellement de",
        "msg.unsealing": "Descellement de",
