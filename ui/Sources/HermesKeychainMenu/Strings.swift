...
final class Loc: ObservableObject {
    ...
    static let english: [String: String] = [
        ...
        "tut.title": "Learn and set up HEUCAT",
        "tut.subtitle": "Understand macOS protection, learn the interface, then secure your first credentials.",
        "tut.security.title": "1. The macOS security basics",
        "tut.security.subtitle": "Four ideas are enough to choose the right protection.",
        "tut.security.keychain.title": "Keychain",
        "tut.security.keychain.body": "macOS's password vault. HEUCAT stores credentials there instead of readable .env files.",
        "tut.security.plain.title": "Plain secret",
        "tut.security.plain.body": "Available to Hermes without Touch ID. Choose it only for background jobs that must start unattended.",
        "tut.security.enclave.title": "Enclave secret",
        "tut.security.enclave.body": "Encrypted with a hardware key that cannot leave your Mac. Touch ID is required before use.",
        "tut.security.session.title": "Unlock session",
        "tut.security.session.body": "A temporary Keychain copy lets Hermes work after one Touch ID. Locking or expiry closes access.",
        "tut.security.rule": "Simple rule: use Enclave by default. Use Plain only when automation must work while you are away.",
        "tut.ui.title": "2. Learn the interface",
        "tut.ui.subtitle": "Click a card to open that screen. You can return to Tutorial at any time.",
        "tut.ui.overview.title": "Overview",
        "tut.ui.overview.body": "See overall health, counts and the next useful action.",
        "tut.ui.secrets.title": "Secrets",
        "tut.ui.secrets.body": "Add, update, test or remove a credential. Values are never shown after saving.",
        "tut.ui.sessions.title": "Sessions",
        "tut.ui.sessions.body": "Unlock enclave secrets with Touch ID, choose a duration and lock them immediately.",
        "tut.ui.profiles.title": "Sealed Profiles",
        "tut.ui.profiles.body": "Protect an entire Hermes profile and see which profile is currently active.",
        "tut.ui.how.title": "How it works",
        "tut.ui.how.body": "Follow the path from Hermes to Keychain, Secure Enclave and the temporary session.",
        "tut.ui.diagnostics.title": "Diagnostics",
        "tut.ui.diagnostics.body": "Check installation paths and components when a status or action fails.",
        "tut.checklist.title": "3. Configure your Mac",
        "tut.checklist.subtitle": "These checks update from the real system. Use the buttons to complete the missing steps.",
        "tut.done": "Done",
        "tut.todo": "To do",
    ...
    static let french: [String: String] = [
        ...
        "tut.title": "Comprendre et configurer HEUCAT",
        "tut.subtitle": "Apprenez la protection macOS, découvrez l’interface, puis sécurisez vos premiers identifiants.",
        "tut.security.title": "1. Comprendre la sécurité macOS",
        "tut.security.subtitle": "Quatre notions suffisent pour choisir la bonne protection.",
        "tut.security.keychain.title": "Trousseau macOS",
        "tut.security.keychain.body": "Le coffre-fort de mots de passe du Mac. HEUCAT y stocke les identifiants au lieu de fichiers .env lisibles.",
        "tut.security.plain.title": "Secret simple",
        "tut.security.plain.body": "Accessible à Hermes sans Touch ID. À réserver aux tâches automatiques qui doivent démarrer sans vous.",
        "tut.security.enclave.title": "Secret Enclave",
        "tut.security.enclave.body": "Chiffré avec une clé matérielle qui ne quitte pas le Mac. Touch ID est requis avant utilisation.",
        "tut.security.session.title": "Session déverrouillée",
        "tut.security.session.body": "Une copie temporaire dans le Trousseau permet à Hermes de travailler après un Touch ID. Le verrouillage coupe l’accès.",
        "tut.security.rule": "Règle simple : choisissez Enclave par défaut. Utilisez Simple uniquement si une automatisation doit fonctionner en votre absence.",
        "tut.ui.title": "2. Apprendre l’interface",
        "tut.ui.subtitle": "Cliquez sur une carte pour ouvrir l’écran. Revenez au Tutoriel à tout moment.",
        "tut.ui.overview.title": "Vue d’ensemble",
        "tut.ui.overview.body": "Consultez l’état général, les compteurs et la prochaine action utile.",
        "tut.ui.secrets.title": "Secrets",
        "tut.ui.secrets.body": "Ajoutez, modifiez, testez ou supprimez un identifiant. Sa valeur n’est plus affichée après l’enregistrement.",
        "tut.ui.sessions.title": "Sessions",
        "tut.ui.sessions.body": "Ouvrez les secrets Enclave avec Touch ID, choisissez une durée ou reverrouillez immédiatement.",
        "tut.ui.profiles.title": "Profils scellés",
        "tut.ui.profiles.body": "Protégez un profil Hermes complet et identifiez le profil actuellement utilisé.",
        "tut.ui.how.title": "Fonctionnement",
        "tut.ui.how.body": "Suivez le trajet entre Hermes, le Trousseau, la Secure Enclave et la session temporaire.",
        "tut.ui.diagnostics.title": "Diagnostic",
        "tut.ui.diagnostics.body": "Contrôlez les chemins et composants lorsqu’un état ou une action échoue.",
        "tut.checklist.title": "3. Configurer votre Mac",
        "tut.checklist.subtitle": "Ces contrôles lisent l’état réel du système. Utilisez les boutons pour terminer les étapes manquantes.",
        "tut.done": "Fait",
        "tut.todo": "À faire",
